"""
Django settings for que_bookstore project.
...
SECRET_KEY = 'django-insecure-y9_sh6$2yz)=a!d#h!*2ra4)%#=0)h3c3n^^brxaiqr_1a)-+&'
...
MIDDLEWARE = [
    ...
    'user.middlewares.RedirectToLoginMiddleware',
...
WSGI_APPLICATION = 'que_bookstore.wsgi.application'
